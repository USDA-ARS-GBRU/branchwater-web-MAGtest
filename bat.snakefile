...
# This workflow processes multiple metagenomes, annotating bins using CAT_pack and summarizing 
...
# 4. Download the metagenome bins you want to annotate from the associated Zenodo repository.
...
#    snakemake -s bat.snakefile --use-conda --cores 20 --rerun-incomplete --keep-going --latency-wait 60 --printshellcmds -n
#
